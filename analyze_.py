...
def loadModel():
    ...
    interpreter = tflite.Interpreter(model_path='BirdNET-Lite/model/BirdNET_6K_GLOBAL_MODEL.tflite', num_threads = num_cpus)
    ...
    # Load labels
    CLASSES = []
    with open('BirdNET-Lite/model/labels.txt', 'r') as lfile:
